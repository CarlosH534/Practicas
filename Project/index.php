      ...
      <div class="justify-content-center mt-5">
          <div class="row mt-3 text-center">
            <div class="col-sm-12 col-md-12 col-lg-12 text-center">
                <h1 class="text-center display-6">bot | <span>Login</span></h1>
                <div class="row mt-2 px-1 justify-content-center mt-5">
                    ...
                    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" autocomplete="off" class="needs-validation" novalidate>
                      <div class="row mt-2 justify-content-center">
                        <div class="col-sm-8 col-md-8 col-lg-8">
                            <input type="text" name="Usuario" id="Usuario" placeholder="Usuario" class="form-control border-3 rounded-pill border-success" autocomplete="off" required />
                            <div class="invalid-feedback">Por favor ingresa tu Usuario</div>
                        </div>
                      </div>
                      <div class="row mt-2 mb-2 justify-content-center">
                          <div class="col-sm-8 col-md-8 col-lg-8">
                            <input type="password" name="Password" id="pass" placeholder="contraseña" class="form-control border-3 rounded-pill border-success" autocomplete="off" required />
